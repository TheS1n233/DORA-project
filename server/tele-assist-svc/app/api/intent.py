...
def _cfg():
    ...
    return {
        "target": os.getenv("TA_INTENT_TARGET", "tv").strip().lower(),  # "tv" or "assistant"
...
async def post_intent(request: Request, via: Optional[str] = None, broadcast: int = 1, cowatch: int = 0):
